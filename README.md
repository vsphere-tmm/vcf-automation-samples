...
#### 4. Steps to download and generate project-service client sdk
...
- Ensure script has execute permission by executing `chmod +x .generated_sdk.sh`
- This script would
